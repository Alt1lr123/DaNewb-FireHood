...
notifications:notify{
    Title = "Welcome",
    Description = "Welcome To FireHood",
    Accept = {
        Text = "Ok !"
    },
    Length = 10
...
local Tab5 = Window:NewTab("Marco")
local Tab5Section = Tab5:NewSection("Mobile Marco")

Tab5Section:NewButton("Fake Speed Glitch", "Speed", function()
...
Tab5Section:NewButton("Fake Marco", "Do Animation", function()
game.Players.LocalPlayer:GrtMouse()
tool = Instance.new("Tool")
tool.RequiresHandle = False
tool.Name = "Fake Marco"
tool.Actuvated:connect(function()
stopTracks()
                loadAnimation("rbxassetid://3189779152")
...
local Tab5Section = Tab5:NewSection("Marco Pc")

Tab5Section:NewButton("Speed Glitch [X]", "Speed", function()
--Settings
...
Tab5Section:NewButton("Fake Marco Animation", "Fake Marco", function()
_G.Key = "x"
...
local Tab5Section = Tab5:NewSection("Press This When Fake Speed Glitch")

Tab5Section:NewToggle("Auto Shift", "Auto Shift So Its Look Real", function(state)
    if state then
while true do
wait(0.2)
...
local Tab14 = Window:NewTab14("TabName")
local 14Section = 14:NewSection("Remove Your Gun Sound")

14Section:NewButton("SMG", "Silent Gun", function()
wait()
...
14Section:NewButton("AR", "Silent Gun", function()
wait()
...
14Section:NewButton("Shotgun", "Silent Gun", function()
wait()
...
14Section:NewButton("Silencer", "Silent Gun", function()
wait()
...
14Section:NewButton("P90", "Silent Gun", function()
wait()
...
14Section:NewButton("Glock", "Silent Gun", function()
wait()
...
local Tab15 = Window:NewTab("Stands")
local 15Section = 15:NewSection("Stands")

15Section:NewButton("Bat Man", "Bat Man Stand", function()
...
Tab15Section:NewButton("Venom", "Venom Stands", function()
local OriginalKeyUpValue = 0;
...
Tab15Section:NewButton("Deadshot", "Deadshot", function()
pcall(function()
...
Tab15Section:NewButton("Hearing", "Hearing Stand", function()
grm = getrawmetatable(game)
setreadonly(grm, false)
old = grm.__namecall
grm.__namecall = newcclosure(function(self, ...)
...
Tab15Section:NewButton("Wolverine", "Wolverine Stand", function()
local OriginalKeyUpValue = 0
local LocalPlayer = game:GetService("Players").LocalPlayer
...
local Tab16 = Window:NewTab("Auto Farm")
local Tab16Section = Tab16:NewSection("Auto Farm Script")

Tab16Section:NewToggle("Fist Farm", "Auto Farm", function(state)
    if state then
...
Tab16Section:NewToggle("Letuce Farm", "Auto Farm", function(state)
    if state then
...
Tab16Section:NewToggle("Hostpital Farm", "Auto Farm", function(state)
    if state then
...
Tab16Section:NewToggle("Money Farm", "Auto Farm", function(state)
    if state then
...
local Tab17 = Window:NewTab("Animation")
local Tab17Section = Tab17:NewSection("Animation Script")

Tab17Section:NewButton("Ninja", "Ninja Animation", function()
loadstring(game:HttpGet('https://pastebin.com/raw/3us2GAp7'))()
end)

Tab17Section:NewButton("Cartoony", "Cartoony Animation", function()
loadstring(game:HttpGet('https://pastebin.com/raw/amVNDcQT'))()
end)

Tab17Section:NewButton("Toy", "Toy Animation", function()
loadstring(game:HttpGet('https://pastebin.com/raw/zSNMgiuG'))()
end)

Tab17Section:NewButton("Bubble", "Bubble Animation", function()
loadstring(game:HttpGet('https://pastebin.com/raw/WgetAbi5'))()
end)

Tab17Section:NewButton("Levitaion", "Levitation Animation", function()
loadstring(game:HttpGet('https://pastebin.com/raw/AryTwN4z'))()
end)

Tab17Section:NewButton("Vampire", "Vampire Animation", function()
loadstring(game:HttpGet('https://pastebin.com/raw/xbG6jw7H'))()
end)

Tab17Section:NewButton("Stylish", "Stylish Aniamtion", function()
loadstring(game:HttpGet('https://pastebin.com/raw/xf5jBa86'))()
end)

Tab17Section:NewButton("Zombie", "Zombie Animation", function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/Exploit-blox/Ninja-Legends/main/ReleaseByBEEST'))()
end)

local Tab18 = Window:NewTab("Aimlock")
local Tab18Section = Tab18NewSection("Aimlock [Q]")

Tab18Section:NewButton("Aimlock","Aimlock",function()
...
Tab18Section:NewTextBox("Aimlock Key","Aimlock Key should be lowercase.",function(L_69_arg0)
	getgenv().AimlockKey = L_69_arg0
end)

Tab18Section:NewTextBox("Aimlock Prediction","Customize your aimlock prediction",function(L_70_arg0)
	PredictionVelocity = L_70_arg0
end)

Tab18Section:NewDropdown("AimPart","AimPart",{"Head","UpperTorso","HumanoidRootPart","LowerTorso"},function(L_71_arg0)
	getgenv().AimPart = L_71_arg0
end)

local Tab18Section = Tab18NewSection("Silent Aim [T]")

Tab18Section:NewButton("Silent Aim","Silent Aim Toggle Key is T.",function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/tayodevelup/imsoniac/main/silentaim", true))()
end)

Tab18Section:NewTextBox("Silent Aim Prediction","0.157 for low ping 0.178 high ping",function(L_72_arg0)
	DaHoodSettings.Prediction = L_72_arg0
end)

Tab18Section:NewDropdown("Silent Aim Part","Choose Part",{"Head","UpperTorso","HumanoidRootPart","LowerTorso"},function(L_73_arg0)
	Aiming.TargetPart = L_73_arg0
end)

Tab18Section:NewTextBox("Silent Aim Size Fov","Silent Aim Size",function(L_74_arg0)
	Aiming.FOV = L_74_arg0
end)

Tab18Section:NewToggle("Silent Aim Show Fov","Show The Silent Aim Fov",function(L_75_arg0)
	Aiming.ShowFOV = L_75_arg0
end)

local Tab18Section = Tab18:NewSection("Anti Lock [Z]")

Tab18Section:NewButton("Anti-Lock","Key is Z.",function()
	repeat
		wait()
	until game:IsLoaded()
	getgenv().Fix = true
...
local Tab18Section = Tab18:NewSection("Other Lock")

Tab18Section:NewButton("Aim Lock {Old Arceus X Aimlock Tools}", "Arceus X AimLock", function()
loadstring(game:HttpGet('https://pastebin.com/raw/HA8kAiYp'))()
end)

Tab18Section:NewButton("Aimbot", "", function()
loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Hyotinhofofinho/s1mple/main/LIXO"))()
end)

Tab18Section:NewButton("Streamable [Q]", "Q", function()
loadstring(game:HttpGet('https://pastebin.com/raw/XfdzBV2y'))()
end)

Tab18Section:NewButton("Aimbot [Q]", "Q", function()
loadstring(game:HttpGet('https://pastebin.com/raw/XzCsiJaD'))()
end)

Tab18Section:NewButton("Kloy Lock [Q]", "Q", function()
loadstring(game:HttpGet('https://pastebin.com/raw/BtQYq4EG'))()
end)

local Tab19 = Window:NewTab("Setting")
local Tab19Section = Tab17:NewSection("Setting")

Tab19Section:NewKeybind("Close/Open", "Close/Open", Enum.KeyCode.Shift, function()
	Library:ToggleUI()
end)

local Tab20 = Window:NewTab("Credits")
local Tab20Section = Tab20:NewSection("FireHood/Da Newb")
Tab20Section:NewLabel("Ui: Kavo Libary")
Tab20Section:NewLabel("Fly Gui V3: me_ozoneYT And Quandle The Dinglish")
Tab20Section:NewLabel("Owner: ALT1LR")
Tab20Section:NewLabel("Discord: https://discord.gg/Pu4ESrztTC")
